...
- [`dev.yml`](../.github/workflows/dev.yml): Creates the images (base, sdxl, sd3, flux variants, qwen image edit) and pushes them to Docker Hub tagged as `<image_name>:dev` on every push to the `main` branch.
